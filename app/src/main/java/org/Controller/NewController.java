...
@Command(name = "CLController", mixinStandardHelpOptions = true, version = "Controller 1.0",
    description = "New UML controller", subcommands = {GenerateCompletion.class})
public class NewController {
    ...
    public NewController(UMLModel model, UMLEditor editor, CLView view) {
		this.model = model;
		this.editor = editor;
		this.view = view;
