...
public class UMLEditor {
    ...
    /**
     * Adds relationship to relationshipList Updates relationshipLength if newRel's name is new
     * longest name
     *
    ...
    public void addMethod(
            ...
            String methodName,
            String retType,
            LinkedHashMap<String, String> paramNameList)
            throws Exception {
        /*
    ...
    public void deleteField(ClassObject cls, String fieldName) throws Exception {
        if (!cls.fieldNameUsed(fieldName)) {
            throw new Exception(
                    "Class " + cls.getName() + " does not have a field named " + fieldName);
        } else {
     ...
     * @throws Exception
     */
    public void renameField(ClassObject cls, AttributeInterface renameAttr, String newName)
            throws Exception {
     ...
     * @throws Exception
     */
    public void renameMethod(ClassObject cls, Method renameMethod, String newName)
            throws Exception {
     ...
     * @param parameterStringList | The new parameter list set as a string to be added as parameter
     *     type
     */
    public void changeParameter(
            Method activeMethod,
            Parameter oldParam,
            LinkedHashMap<String, String> parameterStringList) {
    ...
    public boolean nameAlrAdded(
            String paramName, LinkedHashMap<String, String> buildParamNameList) {
