...
public class Relationship {
    ...
    /**
     * Constructor for a relationship Creates a relationship between a source class and destination
     * class
     *
    ...
    /**
     * Constructor for an unnamed, untyped relationship to not break tests Creates a relationship
     * between a source class and destination class
     *
     * @param ClassObject source | the source of the relationship
     * @param ClassObject dest | the destination of this relationship
    ...
    /**
     * Relationship.getSource(); Gets the current source class of this relationship
     *
    ...
    /**
     * Relationship.getDestination(); Gets the current destination class of this relationship
     *
    ...
    /**
     * Relationship.getID(); Returns the ID of this relationship based on the hash of its source and
     * destination
     *
     * @return int
     */
    ...
    /**
     * Relationship.getType(); Gets the type of this relationship
     *
     * @return Type type
     */
    public Type getType() {
    ...
    /**
     * Relationship.getType(); Gets the type of this relationship as a string
     *
    ...
    /**
     * Relationship.setSource(newSource); Changes this relationship's source to a ClassObject
     * newSource
     *
    ...
    /**
     * Relationship.setDestination(newDest); Changes this relationship's destination to a
     * ClassObject newDest
     *
    ...
    /**
     * Relationship.setType(newType); Sets this relationship's type to newType
     *
     * @param Type newType
     */
